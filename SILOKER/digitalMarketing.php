  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet"/>
	...
	<body>
			...
			<div class="wrapper light-wrapper">
				<div class="rev_slider_wrapper fullwidth-container">
				  <div id="slider14" class="rev_slider fullwidthbanner" data-version="5.4.7">
					<ul>
					  <li data-transition="fade" data-delay="99999999" data-thumb=""><img src="style/images/concept/bannerdigitalmarketing1.png" alt="" />
						<div class="tp-caption font-weight-600 color-purple" 
							 data-x="left" 
							 data-y="middle"  
							 ...
							 data-responsive="on" 
							 data-responsive_offset="on" style="z-index: 9;">Digital Marketing 
						</div>
						<!-- /.tp-caption -->
						<div class="tp-caption font-weight-400 color-purple" 
							 data-x="left" 
							 data-y="middle"   
							 data-hoffset="['250','250','250','175']" 
							 ...
							 data-responsive="on" 
							 data-responsive_offset="on" style="z-index: 9;">Yuk, mulai petualanganmu menjadi Digital Marketer idaman banyak perusahaan.
						</div>
						<!-- /.tp-caption -->
						<a class="tp-caption btn btn-l btn-purple btn-strong-hover scroll" 
							 data-x="left" 
							 data-y="middle"   
							 data-hoffset="['250','250','250','175']" 
      ...
      <!-- Platform yang Dipelajari -->
        ...
        <div class="row clients text-center">
          <div class="col-md-4 col-lg-3">
            <figure class="pl-15 pr-15"><img src="style/images/logo/googleadslogo.png" alt="" /></figure>
          </div>

          <div class="col-md-4 col-lg-2">
            <figure class="pl-15 pr-15"><img src="style/images/logo/googlealanylicslogo.png" alt="" /></figure>
          </div>

          <div class="col-md-4 col-lg-2">
            <figure class="pl-15 pr-15"><img src="style/images/logo/instagramlogo.png" alt="" /></figure>
          </div>

          <div class="col-md-4 col-lg-2">
            <figure class="pl-15 pr-15"><img src="style/images/logo/facebooklogo.png" alt="" /></figure>
          </div>
      ...
      <!-- Metode Belajar -->
			<div class="container inner pt-10">
				<div class="text-center">
					<h2 class="title-bg bg-default color-white">Metode Belajar</h2>
				</div>
				<div class="space10"></div>
                ...
                <div class="container-fluid boxed p-0">
                  ...
                  <div class="image-block-wrapper">
                    <div class="image-block col-lg-6">
                      <div class="image-block-bg bg-image" data-image-src="style/images/concept/formimage-digitalmarketing.png"></div>
                    </div>
                    <!--/.image-block -->
                    <div>
