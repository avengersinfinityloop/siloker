...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2022 at 03:17 PM
...
('10121901', 'mulhan123', 'Mulhan', '2022-07-19', 'Wanita', 'Menikah', 'Indonesia', 10000000, 14436, 2147483647, 'khaerunnisa@corp.bri.co.id', 'jakarta', 'ege', 3462, 'sd', 'sma ceria', 'komputer', 'aegef', 2019, 8, 'qwf', 'supervisio', 'ilmuwan', 'jakarta', 253466, '2022-07-17', 'paruh', 'bem', 'asff', 'afwef', 2017, 'asfwef', 'aefewf', 'aeegweg', '2022-07-13');
...
ALTER TABLE `daftar_kursus`
  ...
  ADD CONSTRAINT `daftar_kursus_ibfk_2` FOREIGN KEY (`idDaftar`) REFERENCES `pasang_iklan` (`idIklan`);
