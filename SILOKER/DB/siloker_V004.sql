...
('mulhan123', '', 'Muhamad Sidik Nur Rizki', '2022-07-14', 'Wanita', 'Menikah', 'Indonesia', 100000, 14436, 2147483647, 'khaerunnisa@corp.bri.co.id', 'surabaya', 'qwfqef', 3462, 'sederajat', 'sma ceria', 'manajemen', 'qwdqw', 2018, 8, 'qwf', 'ceo', 'fotografer', 'jakarta', 253466, '2022-07-20', 'magang', 'bem', 'asff', 'qwdqwd', 2018, 'asfwef', 'qwdqwd', 'aeegweg', '2022-07-05');
...
--
ALTER TABLE `profil`
  ADD CONSTRAINT `profil_ibfk_1` FOREIGN KEY (`nik`) REFERENCES `login` (`username`);
COMMIT;
