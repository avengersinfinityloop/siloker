		...
		<div class="content-wrapper">
			...
			<div class="wrapper light-wrapper">
				<div class="rev_slider_wrapper fullwidth-container">
					<div id="slider14" class="rev_slider fullwidthbanner" data-version="5.4.7">
						<ul>
							<!-- Banner 1 -->
							<li data-transition="fade" data-delay="99999999" data-thumb=""><img src="style/images/concept/banner-selamatdatangv2.png" alt="" />
								<!-- Title -->
								...
								<div class="tp-caption font-weight-400 color-white" 
									...
									data-responsive="on" 
									data-responsive_offset="on" style="z-index: 9;">Bootcamp Nomor 1 yang Fokus di Bidang Industri IT dan Kreatif
								</div>
								<!-- Learn More -->
								<a class="tp-caption btn btn-l btn-white btn-strong-hover scroll" 
									...
									data-responsive="on" 
									data-responsive_offset="on" style="z-index: 9;" href="#pilihanBootcamp">Learn More  
								</a>
							</li>
							<!-- Banner 2 -->
							<li class="light-gallery-wrapper" data-transition="fade" data-delay="99999999" data-thumb=""><img src="style/images/concept/3pilihanbootcamp.png" alt="" />
							</li>
						</ul>
			...
			<div id="pilihanBootcamp" class="container inner">
				...
				<div class="row gutter-60 text-center align-items-end">
					...
					<div class="col-md-4" data-aos="fade-up" data-aos-delay="0">
						<figure class="mb-30"><img src="#" srcset="style/images/concept/digital-marketing.png" alt="" /></figure>
						<h4>Digital Marketing</h4>
						<p class="mb-15">Belajar Facebook Ads dan Tiktok Ads di Digital Marketing selama 4 bulan dari awam sampai paham!</p>
						<div class="text-center"><a href="digitalMarketing.html" class="more">Learn more</a></div>
					</div>
	
					<div class="space20 d-md-none"></div>
					<div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
						<figure class="mb-30"><img src="style/images/concept/ui-ux.png" srcset="style/images/concept/ui-ux.png" alt="" /></figure>
						<h4>UI/UX Designer</h4>
						<p class="mb-15">Belajar dari awam sampai mahir bikin produk lebih menarik pakai tools professional selama 4 bulan</p>
						<div class="text-center"><a href="uiUx.html" class="more">Learn more</a></div>
					</div>

					<div class="space20 d-md-none"></div>
					<div class="col-md-4" data-aos="fade-up" data-aos-delay="800">
						<figure class="mb-30"><img src="style/images/concept/fullstackwebdevelopment.png" srcset="style/images/concept/fullstackwebdevelopment.png" alt="" /></figure>
						...
						<div class="text-center"><a href="fullStackWebDevelopment.html" class="more">Learn more</a></div>
					</div>
				</div>
			</div>
			<!-- Pilihan Bootcamp -->
			...
			<div class="container inner pt-10">
				...
				<div class="row align-items-center">
					<div class="col-lg-6 order-lg-2 text-center">
						<figure><img src="#" srcset="style/images/concept/whyus.png" alt="" /></figure>
					</div>
					<div class="space20 d-md-none"></div>
			...
			<div class="container inner pt-10">
				...
				<div class="carousel owl-carousel clients" data-margin="30" data-loop="true" data-dots="false" data-autoplay="true" data-autoplay-timeout="3000" data-responsive='{"0":{"items": "2"}, "768":{"items": "4"}, "992":{"items": "5"}, "1140":{"items": "6"}}'>
					<div class="item pl-15 pr-15"><img src="style/images/logo/botwlogo.png" alt="" /></div>
					<div class="item pl-15 pr-15"><img src="style/images/logo/ff7remakelogo.png" alt="" /></div>
					<div class="item pl-15 pr-15"><img src="style/images/logo/rdr2logo.png" alt="" /></div>
					<div class="item pl-15 pr-15"><img src="style/images/logo/eldenringlogo.png" alt="" /></div>
					<div class="item pl-15 pr-15"><img src="style/images/logo/revillagelogo.png" alt="" /></div>
					<div class="item pl-15 pr-15"><img src="style/images/logo/ds3logo.png" alt="" /></div>
					<div class="item pl-15 pr-15"><img src="style/images/logo/gowlogo.png" alt="" /></div>
					<div class="item pl-15 pr-15"><img src="style/images/logo/revillagelogo.png" alt="" /></div>
				</div>
			</div>
			<!-- dummy Partner -->
