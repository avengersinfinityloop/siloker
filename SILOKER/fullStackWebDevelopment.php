...
<head>
  ...
  <title>Bootcamp Full Stack Web Development</title>
  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet"/>
	...
	<body>
			...
			<div class="wrapper light-wrapper">
				<div class="rev_slider_wrapper fullwidth-container">
				  <div id="slider14" class="rev_slider fullwidthbanner" data-version="5.4.7">
					<ul>
					  <li data-transition="fade" data-delay="99999999" data-thumb=""><img src="style/images/concept/bannerfullstackwebdevelopment1.png" alt="" />
						<div class="tp-caption font-weight-600 color-sky" 
                data-x="left" 
                data-y="middle"  
                data-hoffset="250" 
                data-voffset="-150" 
                ...
                data-responsive="on" 
                data-responsive_offset="on" style="z-index: 9;">Full Stack Web Development
						</div>
						<!-- /.tp-caption -->
						<div class="tp-caption font-weight-400 color-sky" 
                data-x="left" 
                data-y="middle"   
                data-hoffset="['250','250','250','175']" 
                data-voffset="['10','30','30','60']" 
                ...
                data-responsive="on" 
                data-responsive_offset="on" style="z-index: 9;">Yuk, mulai petualanganmu menjadi Full Stack Web Development idaman banyak perusahaan.
						</div>
						<!-- /.tp-caption -->
						<a class="tp-caption btn btn-l btn-sky btn-strong-hover scroll" 
							 data-x="left" 
							 data-y="middle"   
							 data-hoffset="['250','250','250','175']" 
							 ...
							 data-responsive="on" 
							 data-responsive_offset="on" style="z-index: 9;" href="#tentangProgram">Learn More  
						</a>
						<!-- /.tp-caption -->
					  </li>
        ...
        <div class="text-center">
          <h2 class="title-bg bg-sky color-white">Tentang Program</h2>
        </div>
        <h3 class="display-3 text-center">Wujudkan impian menjadi Full Stack Developer dalam 16 minggu. Jadilah rekrutan 350+ hiring partner dengan garansi 100% uang kembali*.</h3>
      ...
      <div class="container inner pt-10">
				<div class="row align-items-center">
					...
					<div class="col-lg-6 pr-60 pr-md-15">
						<h2 class="title-bg bg-sky color-white">Kurikulum</h2>
              ...
              <div class="card">
                <div class="card-header" id="accordion-heading-1-1">
                  <h5>
                  <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-1-1" aria-expanded="false" aria-controls="accordion-collapse-1-1">Fundamental Programming</button>
                  </h5>
                </div>
                <div id="accordion-collapse-1-1" class="collapse" aria-labelledby="accordion-heading-1-1" data-parent="#accordion-1">
                  <div class="card-body">
                    <p>Siswa akan mempelajari pola pikir seorang programmer untuk menjadi programmer andal.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header" id="accordion-heading-1-2">
                  <h5>
                    <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-1-2" aria-expanded="false" aria-controls="accordion-collapse-1-2">Application Structure</button>
                  </h5>
                </div>
                <div id="accordion-collapse-1-2" class="collapse" aria-labelledby="accordion-heading-1-2" data-parent="#accordion-1">
                  <div class="card-body">
                    <p>Siswa akan mempelajari tentang struktur dalam membuat sebuah aplikasi.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header" id="accordion-heading-1-3">
                  <h5>
                    <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-1-3" aria-expanded="false" aria-controls="accordion-collapse-1-3">Pengenalan Database</button>
                  </h5>
                </div>
                <div id="accordion-collapse-1-3" class="collapse" aria-labelledby="accordion-heading-1-3" data-parent="#accordion-1">
                  <div class="card-body">
                    <p>Siswa akan mempelajari cara membuat database untuk membuat aplikasi.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header" id="accordion-heading-1-4">
                  <h5>
                    <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-1-4" aria-expanded="false" aria-controls="accordion-collapse-1-4">React & React Native</button>
                  </h5>
                </div>
                <div id="accordion-collapse-1-4" class="collapse" aria-labelledby="accordion-heading-1-4" data-parent="#accordion-1">
                  <div class="card-body">
                    <p>Siswa akan mempelajari Library dan Framework terkenal dari JavaScript untuk membuat aplikasi di Android & iOS.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header" id="accordion-heading-1-5">
                  <h5>
                    <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-1-5" aria-expanded="false" aria-controls="accordion-collapse-1-5">Membuat MVP</button>
                  </h5>
                </div>
                <div id="accordion-collapse-1-5" class="collapse" aria-labelledby="accordion-heading-1-5" data-parent="#accordion-1">
                  <div class="card-body">
                    <p>Siswa akan diminta dan akan dibimbing untuk membangun MVP (Minimum Viable Product) untuk portfolio.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header" id="accordion-heading-1-5">
                  <h5>
                    <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-1-5" aria-expanded="false" aria-controls="accordion-collapse-1-5">Final Project</button>
                  </h5>
                </div>
                <div id="accordion-collapse-1-5" class="collapse" aria-labelledby="accordion-heading-1-5" data-parent="#accordion-1">
                  <div class="card-body">
                    <p>Di akhir program siswa akan membuat final project yang akan dipresentasikan di depan Hiring Partner Hacktiv8.</p>
                  </div>
                </div>
              </div>
						</div>
      ...
      <!-- Platform yang Dipelajari -->
			<div class="container inner pt-10">
				<div class="text-center">
					<h2 class="title-bg bg-sky color-white">Platform yang akan Dipelajari</h2>
				</div>
        <div class="space25"></div>
        <div class="row clients text-center">
          <div class="col-md-4 col-lg-3">
            <figure class="pl-15 pr-15"><img src="style/images/logo/htmlcssjslogo.png" alt="" /></figure>
          </div>

          <div class="col-md-4 col-lg-2">
            <figure class="pl-15 pr-15"><img src="style/images/logo/reactlogo.png" alt="" /></figure>
          </div>

          <div class="col-md-4 col-lg-2">
            <figure class="pl-15 pr-15"><img src="style/images/logo/nodejslogo.png" alt="" /></figure>
          </div>

          <div class="col-md-4 col-lg-2">
            <figure class="pl-15 pr-15"><img src="style/images/logo/githublogo.png" alt="" /></figure>
          </div>

          <div class="col-md-4 col-lg-2">
            <figure class="pl-15 pr-15"><img src="style/images/logo/mysqllogo.png" alt="" /></figure>
          </div>
        </div>
			</div>
			<!-- Platform yang Dipelajari -->
      ...
      <!-- Metode Belajar -->
			<div class="container inner pt-10">
				<div class="text-center">
					<h2 class="title-bg bg-sky color-white">Metode Belajar</h2>
				</div>
				<div class="space10"></div>
      ...
      <div id="formDaftar" class="wrapper gray-wrapper">
        <div class="container inner">
          ...
          <div class="text-center"><a href="#" class="btn btn-sky" data-toggle="modal" data-target="#modal-03">Daftar Sekarang</a></div>
                ...
                <div class="container-fluid boxed p-0">
                  ...
                  <div class="image-block-wrapper">
                    <div class="image-block col-lg-6">
                      <div class="image-block-bg bg-image" data-image-src="style/images/concept/formimage-fullstackwebdevelopment.png"></div>
                    </div>
                    <!--/.image-block -->
                    <div>
                        ...
                        <div class="col-lg-6 offset-lg-6">
                          <div class="box p-50 d-flex">
                            <div class="align-self-left">
                              <h4 class="section-title mb-30">Daftar Bootcamp Full Stack Web Development</h4>
                              <form id="form_daftar" method="post" action="connecttodatabase.php">
                                ...
                                <div class="controls">
                                  ...
                                  <div class="form-row">
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <input id="form_namaBootcamp" class="form-control" type="text" name="namaBootcamp" value="Full Stack Web Development" readonly>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                      <div class="form-group custom-select-wrapper">
