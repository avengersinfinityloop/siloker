			...
			<div class="wrapper light-wrapper">
				<div class="rev_slider_wrapper fullwidth-container">
				  <div id="slider14" class="rev_slider fullwidthbanner" data-version="5.4.7">
					<ul>
					  <li data-transition="fade" data-delay="99999999" data-thumb=""><img src="multimedia/image/concept/bannerfullstackwebdevelopment1.png" alt="" />
      ...
      <!-- Platform yang Dipelajari -->
        ...
        <div class="row clients text-center">
          <div class="col-md-4 col-lg-3">
            <figure class="pl-15 pr-15"><img src="multimedia/image/logo/htmlcssjslogo.png" alt="" /></figure>
          </div>

          <div class="col-md-4 col-lg-2">
            <figure class="pl-15 pr-15"><img src="multimedia/image/logo/reactlogo.png" alt="" /></figure>
          </div>

          <div class="col-md-4 col-lg-2">
            <figure class="pl-15 pr-15"><img src="multimedia/image/logo/nodejslogo.png" alt="" /></figure>
          </div>

          <div class="col-md-4 col-lg-2">
            <figure class="pl-15 pr-15"><img src="multimedia/image/logo/githublogo.png" alt="" /></figure>
          </div>

          <div class="col-md-4 col-lg-2">
            <figure class="pl-15 pr-15"><img src="multimedia/image/logo/mysqllogo.png" alt="" /></figure>
          </div>
        </div>
			</div>
			<!-- Platform yang Dipelajari -->
                ...
                <div class="container-fluid boxed p-0">
                  ...
                  <div class="image-block-wrapper">
                    <div class="image-block col-lg-6">
                      <div class="image-block-bg bg-image" data-image-src="multimedia/image/concept/formimage-fullstackwebdevelopment.png"></div>
                    </div>
                    <!--/.image-block -->
                    <div>
